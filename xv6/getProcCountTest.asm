...
int main(void)
{
  ...
  15:	e8 91 03 00 00       	call   3ab <getProcCount>
  ...
  8a:	50                   	push   %eax
  8b:	50                   	push   %eax
  8c:	68 08 08 00 00       	push   $0x808
  91:	6a 01                	push   $0x1
  93:	e8 e8 03 00 00       	call   480 <printf>
        exit();
  98:	e8 66 02 00 00       	call   303 <exit>
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 91 08 00 00       	mov    $0x891,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 40 0b 00 00       	mov    %eax,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d 40 0b 00 00    	mov    0xb40,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 40 0b 00 00       	mov    0xb40,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 ...
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 44 0b 00 00       	mov    $0xb44,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 7d2:	00 00 00 
    if(p->s.size >= nunits){
