...
_threadTest_1:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  1a:	68 28 08 00 00       	push   $0x828
  1f:	6a 01                	push   $0x1
  21:	e8 9a 04 00 00       	call   4c0 <printf>
    int tid = thread_create(stack);
  26:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
  2d:	e8 c9 03 00 00       	call   3fb <thread_create>

    if (tid < 0)
  32:	83 c4 10             	add    $0x10,%esp
  35:	85 c0                	test   %eax,%eax
  37:	0f 88 86 00 00 00    	js     c3 <main+0xc3>
    {
        printf(1, "can not create thread!\n");
    }
    else if (tid == 0)
  3d:	75 54                	jne    93 <main+0x93>
    {
        sleep(100);
  3f:	83 ec 0c             	sub    $0xc,%esp
  42:	6a 64                	push   $0x64
  44:	e8 8a 03 00 00       	call   3d3 <sleep>
        printf(1, "========> im here\n");
  49:	5a                   	pop    %edx
  4a:	59                   	pop    %ecx
  4b:	68 4c 08 00 00       	push   $0x84c
  50:	6a 01                	push   $0x1
  52:	e8 69 04 00 00       	call   4c0 <printf>
  57:	a1 00 10 00 00       	mov    0x1000,%eax
  ...
  63:	83 c0 01             	add    $0x1,%eax
            printf(1, "x is %d\n", x);
  66:	50                   	push   %eax
  67:	68 5f 08 00 00       	push   $0x85f
  6c:	6a 01                	push   $0x1
            x++;
  6e:	a3 00 10 00 00       	mov    %eax,0x1000
            printf(1, "x is %d\n", x);
  73:	e8 48 04 00 00       	call   4c0 <printf>
            sleep(100);
  78:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  7f:	e8 4f 03 00 00       	call   3d3 <sleep>
            if(x>=10){
  84:	a1 00 10 00 00       	mov    0x1000,%eax
  89:	83 c4 10             	add    $0x10,%esp
  8c:	83 f8 09             	cmp    $0x9,%eax
  8f:	7e cf                	jle    60 <main+0x60>
  91:	eb 2b                	jmp    be <main+0xbe>
        // {
        //     printf(1, "x is %d\n", x);
        //     sleep(100);
        // }
  ...
  93:	50                   	push   %eax
  94:	50                   	push   %eax
  95:	68 68 08 00 00       	push   $0x868
  9a:	6a 01                	push   $0x1
  9c:	e8 1f 04 00 00       	call   4c0 <printf>
        thread_wait();
  a1:	e8 5d 03 00 00       	call   403 <thread_wait>
        printf(1,"after ending the child thread, x is %d\n", x);
  a6:	83 c4 0c             	add    $0xc,%esp
  a9:	ff 35 00 10 00 00    	pushl  0x1000
  af:	68 90 08 00 00       	push   $0x890
  b4:	6a 01                	push   $0x1
  b6:	e8 05 04 00 00       	call   4c0 <printf>
  bb:	83 c4 10             	add    $0x10,%esp
                exit();
  be:	e8 80 02 00 00       	call   343 <exit>
        printf(1, "can not create thread!\n");
  c3:	50                   	push   %eax
  c4:	50                   	push   %eax
  c5:	68 34 08 00 00       	push   $0x834
  ca:	6a 01                	push   $0x1
  cc:	e8 ef 03 00 00       	call   4c0 <printf>
  d1:	83 c4 10             	add    $0x10,%esp
  d4:	eb e8                	jmp    be <main+0xbe>
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
  dc:	66 90                	xchg   %ax,%ax
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 c0 08 00 00 	movzbl 0x8c0(%edx),%edx
